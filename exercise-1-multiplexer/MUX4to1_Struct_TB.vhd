...
entity MUX4to1_Struct_TB is
end entity MUX4to1_Struct_TB;

architecture MUX4to1_Struct_TBArch of MUX4to1_Struct_TB is
    signal a_TB, b_TB, c_TB, d_TB, o_TB : std_logic;
    signal s_TB : std_logic_vector(1 downto 0);

    component MUX4to1_Struct is
        port(
...
end architecture MUX4to1_Struct_TBArch;
